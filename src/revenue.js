...
const Revenue = (() => {
  ...
  const showAffiliateOffer = () => {
    ...
    inner.innerHTML =
      ...
      '<a href="https://scrivlo.io/affiliate" style="background:#5c6ef8;color:#fff;padding:.5rem 1rem;border-radius:8px;font-weight:700;font-size:.85rem;text-decoration:none;display:inline-block">Get your link</a>';
